                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                <li><a href="/shop">All(90)</a></li>
                                                @foreach($categories as $category)
                                                <li class="active"><a  href="{{route('categories.index', ['id' => $category->id])}}">{{$category->name}}({{$category->quantity}})</a></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                        <div class="product__item sale">
                            ...
                            <div class="product__item__text">
                                ...
                                <a href="#" data-product_id="{{ $product->id }}" class="add-cart">+ Add To Cart</a>
                                <div class="rating">
